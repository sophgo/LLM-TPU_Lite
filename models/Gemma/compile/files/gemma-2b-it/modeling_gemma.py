...
class GemmaAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if 'rotary_pos_emb_list' in kwargs:
            cos, sin = kwargs['rotary_pos_emb_list']
        else:
        ...
        if 'layer_past' in kwargs:
            key_past, value_past = kwargs['layer_past']
            key_states = torch.cat([key_past, key_states], dim = -2)
            value_states = torch.cat([value_past, value_states], dim = -2)
